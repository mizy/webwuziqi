...
class DB{
    ...
    private $db_database="wuziqi"; //数据库名
    private $conn="pconn"; //数据库连接标识;持久链接
    ...
    public function connect() {
        if ($this->conn == "pconn") {
            //永久链接
            $this->conn = mysql_pconnect($this->host, $this->db_user, $this->db_pwd);
        } else {
            //即使链接
            $this->conn = mysql_connect($this->host, $this->db_user, $this->db_pwd);
        }
